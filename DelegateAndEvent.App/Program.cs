...
using DelegateAndEvent.App;
using DelegateAndEvent.App.Event;
using static DelegateAndEvent.App.SalaryCalculator;
using Person = DelegateAndEvent.App.Event.Person;
...
categoryRepository.SetThresholdCategoryCount(20);
